const AllowOrRistrictOpenAPIs=()=>{
    return <div style={{paddingLeft:"2rem",paddingRight:"2rem",paddingTop:"0.5rem"}}>
        <div style={{borderBottom:"1px solid black",fontSize:"1.5rem",padding:"1rem",fontWeight:"bold"}}>
            Allow/Restrict Usage Of Open APIs
        </div>
        <div style={{paddingLeft:"1rem",marginBottom:"5%"}}>
            <div style={{fontSize:"1rem"}}>
               {`First go to Open APIs > View Open APIs.`}
            </div>
            <div style={{fontSize:"1rem"}}>
               {`For making an open api  public and enabling it to be used or deleting it,  click on circle and update status.`}
            </div>
            <div style={{textAlign:"center"}}>
               <img src="./integration/image19.png" width={"500"}/>
            </div>
...
export default AllowOrRistrictOpenAPIs;