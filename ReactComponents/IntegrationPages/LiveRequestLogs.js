const LiveRequestLogs=()=>{
    return <div style={{paddingLeft:"2rem",paddingRight:"2rem",paddingTop:"0.5rem"}}>
        ...
        <div style={{paddingLeft:"1rem",marginBottom:"5%"}}>
            ...
            In this option you can monitor the incoming requests and outgoing responses from the desktop application.
            </div>
            <div style={{fontSize:"1rem"}}>
               <b> 1 : </b>Click the Live Logs option and list of incoming requests and responses will appear.

            </div>
            <div style={{textAlign:"center"}}>
               <img src="./integration/image45.png" width={"600"}/>
            </div>
          
            {/* <div style={{fontSize:"1rem",marginTop:"2%"}}>
               <b> 2 : </b>Now select and click the allow or Restrict button.
            </div>
            <div style={{textAlign:"center",marginTop:"2%"}}>
               <img src="./integration/image27.png" width={"600"}/>
            </div> */}
            {/* <div style={{fontSize:"1rem",marginTop:"2%"}}>
