    ...
    return <div style={{paddingLeft:"2rem",paddingRight:"2rem",paddingTop:"0.5rem"}}>
        ...
        <div style={{paddingLeft:"1rem",marginBottom:"5%"}}>
            <div style={{fontSize:"1rem"}}>
               {`This option is used when you have a lot of host access urls and open APIs and you terminate all of them immediately. Then no request will be entertained.`}
            </div>
            <div style={{fontSize:"1rem"}}>
               {`Once you click the “Terminate All” button then you should see a response message.`}
            </div>
            <div style={{textAlign:"center",marginTop:"2%"}}>
               <img src="./integration/image38.png" width={"600"}/>
            </div>
