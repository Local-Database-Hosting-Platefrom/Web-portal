    ...
    return <div>
        <Grid container>
            <Grid item xs={8} style={{borderBottom:"1px solid #7ea69f",padding:"1%"}}>
                ...
                <Heading text={"Here you can create the developers accounts and generate tokens for them and view all their requests and other statistics "} fontSize={"0.8rem"}/>
