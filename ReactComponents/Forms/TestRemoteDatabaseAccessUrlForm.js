...
const TestRemoteDatabaseAccessUrlForm = () => {
    ...
    <Grid container>
        <Grid item md={7} xs={12}>
          <div style={{ marginLeft: isMediumScreen?"1.5rem":""  }}>
            <Heading text={"Remote Database Access Url"} fontSize={isMediumScreen ? "2rem":"1.5rem"}/>
          </div>
        </Grid>
...
export default TestRemoteDatabaseAccessUrlForm;
