import { Box, Container, Divider, Grid, Tab, Tabs, useMediaQuery } from "@mui/material";
    ...
    return    <div className={classes.root}>
            ...
            <Grid item xs={12}>
              <Grid container>
                ...
                >
                  ...
                  >
                    <Heading text={"Host access url"} fontSize={"1.2rem"} />
                  </div>
                  <Divider />
                  <div
                    style={{
                  ...
                  >
                    <Heading text={"Remote database access url"} fontSize={"1.2rem"} />
                  </div>
                  <Divider />
                  {/* <div
                    style={{
        ...
        <Grid container>
          ...
          >
            ...
            >
              <Tab style={{ color: "black" }} label="Host Access Url" />
              <Tab style={{ color: "black" }} label="Remote database url"/>
