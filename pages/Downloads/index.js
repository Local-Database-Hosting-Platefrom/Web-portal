  ...
  return (
    <div className={classes.root}>
      <div style={{ marginLeft: "10%", marginTop: "5rem" }}>
        <Heading
          text={"Desktop Application Setup"}
          fontSize="2rem"
          fontWeight={"bold"}
        />
      </div>
        ...
        <Grid container style={{ textAlign: "center" }}>
          ...
          <Grid item xs={3}>
            <Card
              ...
              cover={<img alt="example" src="/windows.png" width="250" />}
            >
              <div>
                ...
                <div style={{ marginTop: "3%" }}>
                  <Button
                    ...
                    onClick={() => {
                      window.open(
                        "https://drive.google.com/file/d/1qqDkglfd5ybSqpe-vpRjZq67sR8INJp8/view?usp=sharing"
                      );
                    }}
                  >
                    Download
